...
-- load characters map
local chars_file = io.open(minetest.get_modpath("digilines_monitor").."/characters", "r")
local charmap = {}
local max_chars = 12
if not chars_file then
print("[digilines_monitor] E: character map file not found")
else
while true do
...
if o:get_entity_name() == "digilines_monitor:text" then
o:remove()
end
end
end
...
z = pos.z + lcd_info.delta.z}, "digilines_monitor:text")
...
minetest.register_node("digilines_monitor:monitor", {
...
minetest.add_node(pos, {name = "digilines_monitor:dl_monitor", param2 = 3})
end
prepare_writing (pos)
end,
...
minetest.register_entity("digilines_monitor:text", {
...
print("[digilines_monitor] W: unknown symbol in '"..s.."' at "..i)
i = i + 1
end
if file ~= nil then
